      ...
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://github.com/Biggerwad"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
                <img style={{ width: '2rem' }} src="./img/github-icon.png" alt="Logo" />
              </a>
            </li>
            <li>
              <a
                href="https://www.instagram.com/weseyofafrica"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.twitter.com/daniel_Wesey"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/daniel-wesey/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
